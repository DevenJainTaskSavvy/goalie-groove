    ...
    <div className="flex flex-col space-y-4 mb-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button
          ...
          className={`flex items-center justify-center gap-2 py-6 ${goalSize === 'micro' ? 'ring-2 ring-primary/50' : ''}`}
        >
        ...
        <Button
          ...
          className={`flex items-center justify-center gap-2 py-6 ${goalSize === 'macro' ? 'ring-2 ring-primary/50' : ''}`}
        >
